...
namespace Michelin_Garda_2021
{
    public partial class Zarzadzanie : Form
    {
        ...
        public Zarzadzanie()
        {
            ...
            PobierzListeUzytkownikow read = new PobierzListeUzytkownikow();
            users1 = read.pokazUzytkownikow();
            PobierzZawody readZawody = new PobierzZawody();
            zawodies = readZawody.pokazZawody();
            PobierzKonkurencja read1 = new PobierzKonkurencja();
            konkurencjes = read1.pokaz();

            PobierzSedziow read2 = new PobierzSedziow();
            sedziowies = read2.pokaz();

            PobierzKonkurencjeWZawodach readKonkurencjaWZawodach = new PobierzKonkurencjeWZawodach();
        ...
        private void anuluj_Click(object sender, EventArgs e)
        {
            ...
            Uzytkownik users = new Uzytkownik();
            if (potwierdzenie.tak_zmien)
            {
                ...
                try
                {
                    for (int i = 0; i < kopiaUsers.Count; i++)
                    {
                        ...
                        ZmienUzytkownikow_w_Bazie userInBaza = new ZmienUzytkownikow_w_Bazie();
        ...
        private void szukaj_Click(object sender, EventArgs e)
        {
            try
            {
                PobierzListeUzytkownikow read = new PobierzListeUzytkownikow();
                users1 = read.pokazUzytkownikow();
                List<Uzytkownik> useryNowe = new List<Uzytkownik>();
                switch (coZaznaczone())
                {
                    case 0:
        ...
        {
            PobierzZawody read = new PobierzZawody();
            ...
            if (potwierdzenie.tak_zmien)
            {
               ...
               try
             {
                    foreach (DataGridViewRow row in dataGridView2.Rows)
                    {
                        ...
                        ZmienZawodyWBazie updateZawodyIn = new ZmienZawodyWBazie();
        ...
        {
            PobierzKonkurencja read = new PobierzKonkurencja();
        ...
        private void button10_Click(object sender, EventArgs e)//zapisz konkurencje
        {
               ...
               try
            {
                    foreach (DataGridViewRow row in dataGridView3.Rows)
                    {
                        ...
                        ZmienKonkurencjaInBaza updateZawodyIn = new ZmienKonkurencjaInBaza();
        ...
        {
            PobierzSedziow read = new PobierzSedziow();
        ...
        private void button18_Click(object sender, EventArgs e)// dodaj konkurencje w zawodach
        {
            ...
            if (potwierdzenie.tak_zmien)
            {
                ...
                try
                {
                    ...
                    DodajKonkurencjeWZawodach addKonkurencjeW = new DodajKonkurencjeWZawodach();
        ...
        private void button19_Click(object sender, EventArgs e)// usun konkurencje w zawodach
        {
            ...
            if (potwierdzenie.tak_zmien)
            {
                ...
                try
                {
                    ...
                    UsunBazaKonkurencjaWZawodach deleteInBazaKonkurencjaW = new UsunBazaKonkurencjaWZawodach();
        ...
        private void wybraneZawody_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PobierzDanaKonkurencjaWZawodach readDana = new PobierzDanaKonkurencjaWZawodach();
                ...
                try
                {
                    foreach (DataGridViewRow row in dataGridView8.Rows)
                    {
                       ...
                       // wyniki.contests_id = Convert.ToInt64(row.Cells[2].Value);
                        ...
                        ZmienWynikiWBazie update = new ZmienWynikiWBazie();
